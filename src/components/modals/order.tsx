      ...
      <div className="bg-white p-4 rounded-md shadow-md lg:w-2/5 lg:space-x-4">
        ...
        <form className="lg:flex lg:flex-wrap">
          ...
          <div className="mb-4 lg:w-1/2 p-4">
            ...
            <select id="broker" name="broker" value={formData.broker} onChange={handleChange} className="w-full px-4 py-2 border rounded-md">
          ...
          <div className="mb-4 lg:w-1/2 p-4">
            ...
            <select id="assetType" name="assetType" value={formData.assetType} onChange={handleChange} className="w-full px-4 py-2 border rounded-md">
